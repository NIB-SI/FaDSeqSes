...
% ----------------------------------------------------------------
\title{Expression analysis - linear model}
\author{A. Blejec}
%\address{}%
%\email{}%
%
...
<<results='hide'>>=
cat(knit_child(file.path(".","10a_Read-Data.Rnw"),quiet=TRUE))
@
...
<<results='asis'>>=
cat(knit_child(file.path(".","20a_limma-fit.Rnw"),quiet=TRUE))
@

\section{Linear models 2019}
